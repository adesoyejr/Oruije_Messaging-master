...
public class PreviewImage extends Fragment {
    ...
    public static PreviewImage newInstance(String get_path) {
        PreviewImage fragment = new PreviewImage();
        Bundle args = new Bundle();
        args.putString("image_path", get_path);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_preview_image, container, false);
        preview_image = v.findViewById(R.id.preview_image);

        if (image_path != null) { //check if image is not null
